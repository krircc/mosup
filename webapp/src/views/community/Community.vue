              ...
              <div id="content">
                    <div id="theme">
                        <div id="items" v-for="(theme, index) in community_theme_list" :key="index">
                            <div id="office" v-if="theme.community_tag_name === 'Announce'">
                                    <div id="avatar">
                                    ...
                                    <div id="mobile">
                                        <div id="office-title">
                                            ...
                                            <span id="title-name"><a :href="'/a/'+ community_name + '/theme/' + theme.id" title="theme.title">{{theme.title}}</a></span>
                                        </div> 
                                        <div id="detail">
                        ...
                        <div id="items" v-for="(theme, index) in community_theme_list" :key="index">
                            <div id="item" v-if="theme.community_tag_name !== 'Announce'">
                                    <div id="avatar">
                                        <a :href="'/a/user/' + theme.user_id"><img :src= theme.user_avatar ></a>
                                    </div>
                                    <div id="mobile">
...
#center #theme #items #community-tag-name {
    border-radius: 10%;
    color: #1362f5;
    font-size: 0.8rem;
