                ...
                <div id="items" v-for="(theme, index) in saves" :key="index">
                            <div id="item">
                                <div id="infos">
                                    ...
                                    <span id="info"><a :href="'/a/community' + '/theme/' + theme.id">主题{{ theme.id }}</a></span>&emsp;
                                    <span id="info"><a :href="'/a/community' + '/theme/' + theme.id">{{ theme.comment_count }}</a></span>&emsp;
                                    <span id="info">{{ theme.view_count }}</span>&emsp;
                                    <span id="info"> {{ theme.created_at }} </span>
                                </div> 
                                <div id="item-title">
                                  <a :href="'/a/community' + '/theme/' + theme.id" title="theme.title"> {{ theme.title }} </a>
                                </div>
                            </div>
                      </div>
            </div>
