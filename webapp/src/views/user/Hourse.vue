        ...
        <div id="container">
            <div id="center">
                <div id="items" v-for="(theme, index) in theme_list" :key="index">
                            <div id="item">
                                <div id="infos">
                                    <!-- <span id="info"><a :href="'/a/home/' + theme.community_name">{{ theme.community_name_cn }}</a></span>&emsp; -->
                                    <span id="info"><a :href="'/a/user/' + hourse_user.id">{{ hourse_user.username }}</a></span>&emsp;
                                    <span id="info"><a :href="'/a/'+ theme.community_name + '/theme/' + theme.id">{{ theme.comment_count }}</a></span>&emsp;
                                    <span id="info">{{ theme.view_count }}</span>&emsp;
                                    <span id="info"> {{ theme.created_at }} </span>
                                </div> 
                                <div id="item-title">
                                  <a :href="'/a/'+ theme.community_name + '/theme/' + theme.id" title="theme.title"> {{ theme.title }} </a>
                                </div>
                            </div>
                      </div>
            </div>
...
@media only screen and (min-width: 1000px) {
    ...
    #container #aside #right #userself {
        margin: 0.5rem auto;
    }
    #container #aside #right #update {
        margin: 1rem auto;
